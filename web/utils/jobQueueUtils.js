...
export function bulkOperationMutationJobId({
  ...
  if (operationId && shopifyBulkOperationId) {
    return joinSafeJobId("bulk-operation-mutation", shop, operationId, shopifyBulkOperationId);
  }
  return buildBulkOperationMutationJobId({
    shop,
    operationId: operationId || shopifyBulkOperationId || "unknown",
  });
}
...
export function buildAutomaticRuleRunJobId({ shop, ruleId, executionDedupeKey }) {
  return joinSafeJobId("automatic-rule-run", shop, ruleId, executionDedupeKey);
}

export function buildBulkResultIngestJobId({ shop, shopifyBulkOperationId }) {
  return joinSafeJobId("bulk-edit-result-ingest", shop, shopifyBulkOperationId);
}
...
export function bulkEditResultIngestJobId({ shop, shopifyBulkOperationId }) {
  return buildBulkResultIngestJobId({ shop, shopifyBulkOperationId });
}
