...
export function normalizeCreateAutomaticProductRuleCommand(body = {}) {
  return {
    ...
    scopeType: toNullableString(body.scopeType),
...
function hasTargetDefinition(command = {}) {
  ...
  if (Array.isArray(command.filterParams) && command.filterParams.length > 0) return true;
  return false;
}
...
export function normalizeUpdateAutomaticProductRuleCommand(body = {}) {
  return {
    ...
    scopeType: body.scopeType === undefined ? undefined : toNullableString(body.scopeType),
