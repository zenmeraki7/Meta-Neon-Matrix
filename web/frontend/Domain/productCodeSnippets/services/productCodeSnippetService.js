...
export async function listProductCodeSnippets(fetchFn, params = {}, options = {}) {
...
export async function getProductCodeSnippet(fetchFn, id, options = {}) {
...
export async function searchPreviewProducts(fetchFn, search = "", options = {}) {
  const searchParams = new URLSearchParams();
