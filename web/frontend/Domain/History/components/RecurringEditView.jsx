...
const RecurringEditModal = ({ open, onClose, data, isLoading, error, onUpdated }) => {
  ...
  const timeSlotOptions = useMemo(() => generateTimeSlots(), []);
 ...
 const label = t(`runStatus.${normalizedStatus}`);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSubmitError(toSafeErrorMessage(t, error, "common.errors.generic"));
    } finally {
                ...
                <InlineStack gap="800" wrap>
                  ...
                  <Box>
                    ...
                    <Box>
                      ...
                      <CellErrorBoundary fallback="[render error]">
                        <Text variant="bodyMd" as="p" fontWeight="semibold">
                          {numberFormatter.format(totalItems || 0)}
                        </Text>
                      </CellErrorBoundary>
                    </Box>
                </InlineStack>
                  ...
                  <InlineStack gap="800" wrap>
                    <Box>
                      ...
                      <Text variant="headingLg" as="p">
                        {numberFormatter.format(totalRuns || 0)}
                      </Text>
                    </Box>
                    <Box>
                      <Text variant="bodyMd" as="p" tone="subdued">
                      ...
                      <Text variant="headingLg" as="p" tone="success">
                        {numberFormatter.format(totalRunsSucceed || 0)}
                      </Text>
                    </Box>
                    <Box>
                      <Text variant="bodyMd" as="p" tone="subdued">
                      ...
                      <Text variant="headingLg" as="p" tone="critical">
                        {numberFormatter.format(totalFails || 0)}
                      </Text>
                    </Box>
                    <Box>
                      <Text variant="bodyMd" as="p" tone="subdued">
