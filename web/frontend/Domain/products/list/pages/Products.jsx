...
export default function ProductsPage() {
  ...
  const {
    ...
    hasFetched,
    refetch,
    normalizedFilterHash: productsFilterHash,
  } =
    useProducts({
      cursor,
  ...
  const applyAtomicFilterCursorReset = useCallback(
    (nextFilters, nextSearch) => {
      ...
      dispatch(
        applyFilterHashAndResetCursor({
          filters: nextFilters,
          normalizedFilterHash: buildCanonicalFilterHash(nextEffectiveFilters),
        }),
      );
    },
    [dispatch],
  ...
  useEffect(() => {
    ...
    const justCompleted =
      ...
      Boolean(syncStatus?.currentProductMirrorBatchId);
    ...
    syncStatus?.currentProductMirrorBatchId,
    refetch,
    showSuccess,
    t,
  ]);
