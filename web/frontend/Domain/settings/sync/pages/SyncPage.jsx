...
export default function DataSyncPage() {
  ...
  }, [dataSources, isAnySyncRunning, t]);
  ...
  const getDate = useCallback(
    ...
    [dataSources, dateTimeFormatter, t],
  );
  ...
  const isSyncingForKey = useCallback(
    ...
    [dataSources, startProductSync.isPending],
  );

  const summaryTone =
    isAnySyncRunning || startProductSync.isPending ? "warning" : "success";
  ...
  const syncCards = useMemo(
          ...
          <Box padding="500">
            ...
            >
              ...
              <InlineStack gap="300" blockAlign="center">
                {dataSources ? (
                  <Badge
                    tone={isSyncingForKey(item.key) ? "attention" : "success"}
                  >
                    {isSyncingForKey(item.key) ? t("syncing") : t("synced")}
                  </Badge>
                ) : null}
    ...
    [dataSources, getDate, getRowLabel, isSyncingForKey, isAnySyncRunning, startProductSync.isPending, t],
  );
