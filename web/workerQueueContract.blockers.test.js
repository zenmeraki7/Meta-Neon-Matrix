...
test("result ingest producer and worker require canonical shopifyBulkOperationId only", () => {
  ...
  assert.ok(producerSource.includes("requires shop and shopifyBulkOperationId"));
...
test("undo result ingest producer and worker require canonical shopifyBulkOperationId only", () => {
