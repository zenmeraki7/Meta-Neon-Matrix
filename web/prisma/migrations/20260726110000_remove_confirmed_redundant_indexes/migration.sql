...
DROP INDEX IF EXISTS "EditHistory_shop_idx";
DROP INDEX IF EXISTS "Location_shop_idx";
DROP INDEX IF EXISTS "OperationLease_shop_namespace_idx";
DROP INDEX IF EXISTS "OperationStageProgress_shop_operationType_operationId_idx";
...
DROP INDEX IF EXISTS "SpreadsheetFile_shop_idx";
CREATE INDEX IF NOT EXISTS "SpreadsheetFile_shop_createdAt_id_idx"
