...
CREATE UNIQUE INDEX IF NOT EXISTS "bulk_edit_sessions_shop_id_id_key"
  ON "bulk_edit_sessions" ("shop_id", "id");

CREATE UNIQUE INDEX IF NOT EXISTS "variant_metafields_shop_id_id_key"
...
CREATE UNIQUE INDEX IF NOT EXISTS "bulk_edit_changes_shop_id_session_id_variant_metafield_id_key"
  ON "bulk_edit_changes" ("shop_id", "session_id", "variant_metafield_id");

CREATE INDEX IF NOT EXISTS "bulk_edit_changes_shop_id_session_id_status_idx"
  ON "bulk_edit_changes" ("shop_id", "session_id", "status");

CREATE INDEX IF NOT EXISTS "bulk_edit_changes_shop_id_status_updated_at_idx"
  ON "bulk_edit_changes" ("shop_id", "status", "updated_at");

-- ChangeRecord: remove broad indexes and install tenant/workflow composites.
DROP INDEX IF EXISTS "ChangeRecord_editHistoryId_idx";
DROP INDEX IF EXISTS "ChangeRecord_shop_editHistoryId_idx";
DROP INDEX IF EXISTS "ChangeRecord_shop_editHistoryId_targetType_idx";
DROP INDEX IF EXISTS "ChangeRecord_productId_idx";
DROP INDEX IF EXISTS "ChangeRecord_shop_idx";
DROP INDEX IF EXISTS "ChangeRecord_status_idx";
DROP INDEX IF EXISTS "ChangeRecord_batchId_idx";

CREATE INDEX IF NOT EXISTS "ChangeRecord_shop_editHistoryId_status_id_idx"
  ON "ChangeRecord" ("shop", "editHistoryId", "status", "id");

CREATE INDEX IF NOT EXISTS "ChangeRecord_shop_editHistoryId_targetType_id_idx"
  ON "ChangeRecord" ("shop", "editHistoryId", "targetType", "id");

CREATE INDEX IF NOT EXISTS "ChangeRecord_shop_productId_idx"
  ON "ChangeRecord" ("shop", "productId");

CREATE INDEX IF NOT EXISTS "ChangeRecord_shop_batchId_idx"
...
DROP INDEX IF EXISTS "ExportJob_shop_idx";
DROP INDEX IF EXISTS "ExportJob_shop_executionState_idx";
DROP INDEX IF EXISTS "ExportJob_shop_executionStateNormalized_idx";
DROP INDEX IF EXISTS "ExportJob_status_idx";
DROP INDEX IF EXISTS "ExportJob_statusNormalized_idx";
DROP INDEX IF EXISTS "ExportJob_scheduledExportId_idx";
DROP INDEX IF EXISTS "ExportJob_scheduledExportRunId_idx";

CREATE INDEX IF NOT EXISTS "ExportJob_shop_statusNormalized_createdAt_idx"
  ON "ExportJob" ("shop", "statusNormalized", "createdAt");

CREATE INDEX IF NOT EXISTS "ExportJob_shop_executionStateNormalized_updatedAt_idx"
  ON "ExportJob" ("shop", "executionStateNormalized", "updatedAt");

CREATE INDEX IF NOT EXISTS "ExportJob_shop_scheduledExportId_idx"
  ON "ExportJob" ("shop", "scheduledExportId");

CREATE INDEX IF NOT EXISTS "ExportJob_shop_scheduledExportRunId_idx"
