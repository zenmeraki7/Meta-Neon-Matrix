...
CREATE TABLE "variant_metafields" (
    ...
    "edit_status" "EditStatus" NOT NULL DEFAULT 'SYNCED',
...
-- CreateIndex
CREATE INDEX "variant_metafields_variant_id_namespace_key_idx" ON "variant_metafields"("variant_id", "namespace", "key");

-- CreateIndex
CREATE INDEX "variant_metafields_shop_id_is_dirty_idx" ON "variant_metafields"("shop_id", "is_dirty");

-- CreateIndex
CREATE UNIQUE INDEX "variant_metafields_shop_id_variant_id_namespace_key_key" ON "variant_metafields"("shop_id", "variant_id", "namespace", "key");
...
-- RenameForeignKey
ALTER TABLE "BulkEditRecoveryAudit" RENAME CONSTRAINT "bulk_edit_recovery_audit_history_fk" TO "BulkEditRecoveryAudit_historyId_fkey";

-- RenameForeignKey
ALTER TABLE "UndoOperation" RENAME CONSTRAINT "undo_operation_source_history_fk" TO "UndoOperation_sourceEditHistoryId_fkey";

-- RenameForeignKey
ALTER TABLE "UndoOperationConflictChunk" RENAME CONSTRAINT "undo_conflict_chunk_operation_fk" TO "UndoOperationConflictChunk_undoOperationId_fkey";

-- AddForeignKey
ALTER TABLE "variant_metafields" ADD CONSTRAINT "variant_metafields_shop_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "shops"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- RenameIndex
ALTER INDEX "bulk_edit_recovery_audit_shop_history_created_idx" RENAME TO "BulkEditRecoveryAudit_shop_historyId_createdAt_idx";
...
-- RenameIndex
ALTER INDEX "store_product_sync_recovery_required_idx" RENAME TO "Store_productSyncRecoveryRequired_idx";

-- RenameIndex
ALTER INDEX "store_product_sync_started_at_idx" RENAME TO "Store_productSyncStartedAt_idx";

-- RenameIndex
ALTER INDEX "undo_operation_execution_identity_unique" RENAME TO "UndoOperation_executionIdentity_key";

-- RenameIndex
ALTER INDEX "undo_operation_shop_source_history_unique" RENAME TO "UndoOperation_shop_sourceEditHistoryId_key";

-- RenameIndex
ALTER INDEX "undo_operation_shop_status_updated_idx" RENAME TO "UndoOperation_shop_status_updatedAt_idx";

-- RenameIndex
ALTER INDEX "undo_conflict_chunk_unique" RENAME TO "UndoOperationConflictChunk_shop_undoOperationId_chunkType_c_key";
