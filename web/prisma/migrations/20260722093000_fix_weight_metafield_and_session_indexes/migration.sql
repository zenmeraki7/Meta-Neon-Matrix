...
DROP INDEX IF EXISTS "variant_metafields_variant_id_namespace_key_idx";

-- Tenant-scoped operational and history retrieval for bulk-edit sessions.
CREATE INDEX IF NOT EXISTS "bulk_edit_sessions_shop_id_status_updated_at_idx"
  ON "bulk_edit_sessions" ("shop_id", "status", "updated_at");

CREATE INDEX IF NOT EXISTS "bulk_edit_sessions_shop_id_created_at_idx"
