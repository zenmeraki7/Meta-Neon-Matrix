  ...
  async recoverStuckState({
    ...
    try {
      ...
      if (
        ...
        const shopifyBulkOperationId = String(
        ...
        const moved = await this.transitionOperation({
          ...
          allowTerminalOverride: true,
          actor,
          metadata: { mode: "ingest", reason: recoveryReason, shopifyBulkOperationId },
          dataPatch: {
            batch: {
              ...(history.batch && typeof history.batch === "object" ? history.batch : {}),
              recovery: {
        ...
        await this.db.bulkEditRecoveryAudit.create({
          data: {
            ...
            actorEmail: actor?.actorEmail || null,
            result: "RECOVERED",
            metadata: { fromState: currentState, shopifyBulkOperationId },
          },
        }).catch(() => {});
        return { recovered: true, mode: "ingest", historyId, shop, shopifyBulkOperationId };
      }
